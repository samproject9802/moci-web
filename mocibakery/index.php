...
<body>
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#section1">COURSE</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#section2">PRICE</a>
            </li>
            <li class="nav-item dropdown">
              <div class="dropdown">
                <a href="#section3" class="nav-link">PAGES</a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="#section4">FACT</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#section5">ABOUT</a>
            </li>
          </ul>
        </div>
      </nav>
  ...
  <main>
    <section class="section-1">
      <div class="container text-center content-course" id="section1">
        <div class="row">
    ...
    <section class="section-2 container-fluid p-0" id="section2">
      ...
      <div class="purchase text-center" id="section3">
    ...
    <!-- Section 4 -->
    <section class="section-4" id="section5">
      <div class="container text-center">
